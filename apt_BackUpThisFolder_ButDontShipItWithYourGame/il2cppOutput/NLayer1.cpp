...
IL_0331_1:
			{
				...
				NullCheck(L_145);
				int32_t L_146;
				L_146 = VirtualFuncInvoker0< int32_t >::Invoke(36 /* System.Int32 System.IO.Stream::ReadByte() */, L_145);
...
IL_0362_1:
			{
				...
				NullCheck(L_154);
				int32_t L_158;
				L_158 = VirtualFuncInvoker3< int32_t, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(34 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, L_154, L_155, L_156, L_157);
				V_13 = L_158;
				int32_t L_159 = V_13;
				if (!L_159)
				{
...
IL_03c6_1:
			...
			}
			{
				...
				NullCheck(L_182);
				int32_t L_187;
				L_187 = VirtualFuncInvoker3< int32_t, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(34 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, L_182, L_183, L_184, ((int32_t)il2cpp_codegen_subtract(((int32_t)(((RuntimeArray*)L_185)->max_length)), L_186)));
				V_14 = L_187;
